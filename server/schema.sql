...
-- Начальные данные меню (совпадает с seed_dishes.sql)
DELETE FROM dishes;
...
INSERT INTO dishes (category_id, name, description, price, image_url, is_available)
SELECT c.id, 'Ньокки с грибным миксом и трюфельным маслом', 'Ньокки с грибным миксом и трюфельным маслом.', 24.50, NULL, true FROM dish_categories c WHERE c.name = 'Паста и ризотто';
INSERT INTO dishes (category_id, name, description, price, image_url, is_available)
...
INSERT INTO dishes (category_id, name, description, price, image_url, is_available)
SELECT c.id, 'Подмаринованный цукини с сальсой Верде', 'Подмаринованный цукини с сальсой Верде.', 22.50, NULL, true FROM dish_categories c WHERE c.name = 'Закуски';
INSERT INTO dishes (category_id, name, description, price, image_url, is_available)
...
INSERT INTO dishes (category_id, name, description, price, image_url, is_available)
SELECT c.id, 'Тарт Татен с яблоком и сорбентом из малины', 'Тарт Татен с яблоком и малиновым сорбетом.', 17.50, NULL, true FROM dish_categories c WHERE c.name = 'Десерты';
INSERT INTO dishes (category_id, name, description, price, image_url, is_available)
